...
import { createFacturaAction } from '@/app/lib/actions/facturaActions';
...
export default function Form({ proveedores, pedidos }: { proveedores: Proveedor[], pedidos: Pedido[] }) {
  const initialState = { error: '' };
  const [state, formAction] = useActionState(createFacturaAction, initialState);

  const [pedidosSeleccionados, setPedidosSeleccionados] = useState([{ pedidoId: '', total: '' }]);
